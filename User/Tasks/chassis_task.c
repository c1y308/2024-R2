...
void All_Init()
{
	...
	robot_ifo.task_type = CHOICE_MOO;
...
void chassis_arrive_check(void){
...
void chassis_calc_tarspeed_task()
{
...
{
	dji_motor_setref(motor_lf, (+ifo.speed_target.vy + ifo.speed_target.vx + ifo.speed_target.wz));
	dji_motor_setref(motor_lb, (-ifo.speed_target.vy + ifo.speed_target.vx + ifo.speed_target.wz));
	dji_motor_setref(motor_rb, (+ifo.speed_target.vy - ifo.speed_target.vx + ifo.speed_target.wz));
	dji_motor_setref(motor_rf, (-ifo.speed_target.vy - ifo.speed_target.vx + ifo.speed_target.wz));
}
